...
function nuevoUsuario(nombre, email, password) {
  ...
  // Devuelve el objeto
  // Tu código:
  var usernn={nombre:nombre,email:email,password:password,}
  return usernn;
...
function pasarUsuarioAPremium(usuarios) {
  ...
  // Tu código:
  for(var tt=0;tt<usuarios.length;tt++){usuarios[tt].esPremium=true}
  return usuarios
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
var suma=0;
  for(var s=0;s<usuario.posts.length;s++){suma=suma+usuario.posts[s].likes}
  return suma;
}
